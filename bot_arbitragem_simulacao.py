...
EXCHANGE_CREDENTIALS = {
    ...
    'gemini': {'apiKey': os.getenv("GEMINI_API_KEY"), 'secret': os.getenv("GEMINI_SECRET")}, # Adicionando Gemini para ter 10
    'lbank': {'apiKey': os.getenv("LBANK_API_KEY"), 'secret': os.getenv("LBANK_SECRET")}, # Adicionando LBank para ter 10
}

# Exchanges a serem monitoradas (10, excluindo Binance e Coinbase)
EXCHANGES_LIST = [
    'kraken', 'okx', 'bybit', 'kucoin', 'bitstamp',
    'bitget', 'huobi', 'gateio', 'gemini', 'lbank'
]
