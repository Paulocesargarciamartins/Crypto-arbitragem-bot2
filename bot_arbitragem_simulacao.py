...
# --- Aplica nest_asyncio para evitar erro de loop ---
nest_asyncio.apply()
...
# --- Exchanges ---
exchanges_names = ['okx', 'cryptocom', 'kucoin', 'bybit', 'huobi']
exchanges = {}

# --- Taxas ---
spot_fees = {'okx': 0.10, 'cryptocom': 0.075, 'kucoin': 0.10, 'bybit': 0.10, 'huobi': 0.20}
margin_fee_per_hour = {'okx': 0.003, 'cryptocom': 0.03, 'kucoin': 0.03, 'bybit': 0.03, 'huobi': 0.03}

# --- Pares alvo ---
target_pairs = ['XRP/USDT','DOGE/USDT','BCH/USDT','LTC/USDT','UNI/USDT',
...
# --- Inicializa exchanges dentro do loop ---
async def init_exchanges():
    ...
    for name in exchanges_names:
        ...
        try:
            ...
            exchanges[name] = ex
            print(f"[INFO] Exchange iniciada: {name}")
...
async def main_loop():
    ...
    try:
        ...
        telegram_ready = True
        print("[INFO] Cliente Telegram pronto.")
    except Exception as e:
        print(f"[WARN] Telegram não iniciado: {e}")
