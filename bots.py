...
FUT# LISTA EXPANDIDA E VALIDADA DE PARES DE FUTUROS (APROX. 45 PARES)
FUTURES_TARGET_PAIRS = [
    # --- Tier 1: Alta Liquidez e Garantidos ---
    ...
    # --- Tier 2: Boa Liquidez e Verificados ---
    ...
    # --- Tier 3: Outros Pares Relevantes Verificados ---
